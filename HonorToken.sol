...
contract HonorToken is ERC20Permit, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Honor Token", "HONOR", 9) ERC20Permit() {
    ...
    /**
        @notice increases HONOR supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess HONOR
